...
for i in bpy.data.objects["Lighting"].children:
	file.write(i.name+","+str(i.location.x)+","+str(i.location.z)+","+str(-i.location.y)+","+str(i.rotation_quaternion.w)+","+str(i.rotation_quaternion.x)+","+str(i.rotation_quaternion.y)+","+str(i.rotation_quaternion.z)+","+str(i.data.color[0])+","+str(i.data.color[1])+","+str(i.data.color[2])+",\n")
