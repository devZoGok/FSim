...
for i in bpy.data.objects["Structures"].children:
	file.write(i.name+":"+str(i.location.x)+","+str(i.location.z)+","+str(i.location.y)+","+str(i.rotation_quaternion.x)+","+str(i.rotation_quaternion.y)+","+str(i.rotation_quaternion.z)+","+str(i.rotation_quaternion.w)+",\n")
file.close()
